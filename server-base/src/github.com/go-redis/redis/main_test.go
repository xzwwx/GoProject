...
var cluster = &clusterScenario{
	...
	clients:   make(map[string]*Client, 6),
}
...
func redisClusterOptions() *ClusterOptions {
...
func redisRingOptions() *RingOptions {
	return &RingOptions{
...
func connectTo(port string) (*Client, error) {
...
func startSentinel(port, masterName, masterPort string) (*redisProcess, error) {
	...
	for _, cmd := range []*StatusCmd{
		NewStatusCmd(ctx, "SENTINEL", "MONITOR", masterName, "127.0.0.1", masterPort, "2"),
		NewStatusCmd(ctx, "SENTINEL", "SET", masterName, "down-after-milliseconds", "2000"),
		NewStatusCmd(ctx, "SENTINEL", "SET", masterName, "failover-timeout", "1000"),
		NewStatusCmd(ctx, "SENTINEL", "SET", masterName, "parallel-syncs", "1"),
	} {
...
func (h *hook) BeforeProcess(ctx context.Context, cmd Cmder) (context.Context, error) {
...
func (h *hook) AfterProcess(ctx context.Context, cmd Cmder) error {
...
func (h *hook) BeforeProcessPipeline(ctx context.Context, cmds []Cmder) (context.Context, error) {
...
func (h *hook) AfterProcessPipeline(ctx context.Context, cmds []Cmder) error {
